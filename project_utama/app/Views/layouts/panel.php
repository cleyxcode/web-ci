...
<div id="toast" class="toast hidden fixed bottom-28 right-4 z-50 flex w-[min(24rem,calc(100vw-2rem))] items-start gap-3 rounded-2xl border p-4 shadow-xl shadow-slate-900/10 transition-all duration-300 opacity-0 translate-y-2" role="status" aria-live="polite" aria-atomic="true">
    <div class="grid h-8 w-8 shrink-0 place-items-center rounded-xl font-extrabold" id="toast-icon" aria-hidden="true">i</div><div class="min-w-0 flex-1"><strong class="block text-sm font-bold" id="toast-title">Notifikasi</strong><p class="mt-0.5 text-sm opacity-75" id="toast-message"></p></div><button type="button" class="shrink-0 opacity-50 hover:opacity-100 transition-opacity" id="toast-close" aria-label="Tutup notifikasi">&times;</button>
</div>
...
<div id="ui-confirm" class="hidden fixed inset-0 z-50 grid place-items-center p-4" role="dialog" aria-modal="true" aria-labelledby="ui-confirm-title" aria-describedby="ui-confirm-message">
    <div class="absolute inset-0 bg-slate-950/45 backdrop-blur-sm" data-confirm-cancel></div><div class="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-900"><div class="mb-4 grid h-11 w-11 place-items-center rounded-xl bg-rose-100 text-xl font-extrabold text-rose-600 dark:bg-rose-950/60 dark:text-rose-300" id="ui-confirm-icon">!</div><p class="text-xs font-extrabold uppercase tracking-wider text-violet-600 dark:text-violet-400" id="ui-confirm-type">Konfirmasi tindakan</p><h2 class="mt-1 text-xl font-extrabold text-slate-900 dark:text-white" id="ui-confirm-title">Lanjutkan tindakan ini?</h2><p class="mt-2 text-sm text-slate-500 dark:text-slate-400" id="ui-confirm-message"></p><div class="mt-6 flex justify-end gap-2"><button type="button" class="rounded-xl border border-slate-200 px-4 py-2 text-sm font-extrabold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800" data-confirm-cancel>Batal</button><button type="button" class="rounded-xl bg-rose-600 px-4 py-2 text-sm font-extrabold text-white transition hover:bg-rose-700 dark:bg-rose-700 dark:hover:bg-rose-800" id="ui-confirm-submit">Ya, lanjutkan</button></div></div>
</div>
