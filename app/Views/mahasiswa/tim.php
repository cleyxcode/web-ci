...
<?php else: ?>
        ...
        <?php if ($isKetua): ?>
            <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--border-lembut)">
                <p style="margin:0 0 12px;font-size:0.9rem;color:var(--abu-karang)">
                    Sebagai ketua, Anda dapat mengambil lokasi perangkat saat ini, <strong>menggeser pin pada peta</strong>, atau mengisi koordinat manual.
                </p>
                <div id="map-picker" style="height: 300px; width: 100%; border-radius: 6px; margin-bottom: 16px; border: 1px solid var(--border-lembut);"></div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      if (window.L && latInput && lngInput) {
          const defaultLat = parseFloat(latInput.value) || -3.695;
          const defaultLng = parseFloat(lngInput.value) || 128.183;
