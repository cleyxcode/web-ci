<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px" class="dash-grid">
    ...
    <div class="card">
        ...
        <form method="post" action="<?= site_url('admin/profil/password') ?>">
            <?= csrf_field() ?>
            <div class="field">
                <label>Password lama</label>
                <div class="password-wrap">
                    <input type="password" name="current_password" id="current_password" required autocomplete="current-password">
                    <button type="button" class="password-toggle" data-target="current_password" aria-label="Tampilkan password">
