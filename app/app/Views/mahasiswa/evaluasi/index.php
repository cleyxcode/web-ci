    ...
    <div class="mx-auto max-w-5xl space-y-6">
        <section class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 via-cyan-700 to-emerald-700 p-6 text-white shadow-xl sm:p-8">
            ...
            <div class="relative z-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                <div>
                    <p class="text-xs font-extrabold uppercase tracking-[0.2em] text-cyan-100">Evaluasi Dosen Pembimbing Lapangan</p>
        ...
        <div class="flex justify-end">
            <form method="post" action="<?= site_url('mahasiswa/evaluasi/delete') ?>" data-confirm="Hapus evaluasi Anda? Rating dan komentar akan dihapus.">
                <?= csrf_field() ?>
