                    ...
                    <tr>
                        ...
                        <td data-label="Aksi">
                            ...
                            <div style="margin-top: 10px; display: flex; gap: 5px;">
                                <a href="<?= site_url('dpl/logbook/' . (int) $row['id'] . '/edit') ?>" class="btn btn-secondary btn-sm">Edit</a>
                                <form method="post" action="<?= site_url('dpl/logbook/' . (int) $row['id'] . '/delete') ?>" data-confirm="Hapus logbook ini? Tindakan ini tidak dapat dibatalkan." style="display:inline;">
                                    <?= csrf_field() ?>
